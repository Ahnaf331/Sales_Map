...
def generate_central_csv():
    ...
    for i, city1 in enumerate(cities[:30]):
...
def create_dashboard_html(df):
    """Create the HTML dashboard with clustering analysis."""
...
<head>
    ...
    <style>
        * {{
        ...
        .cluster-image-card:hover {{
            transform: translateY(-5px);
            box-shadow: 0 10px 25px rgba(0, 0, 0, 0.15);
        }}
        
        .cluster-image-card img {{
            width: 100%;
            height: auto;
            border-radius: 10px;
            display: block;
...
<body>
    <div class="container">
        ...
        <h2 class="section-title">Interactive Maps</h2>
        ...
        <div class="clustering-section">
            <h2 class="clustering-title">CUSTOMER SEGMENTATION ANALYSIS</h2>
            <p class="clustering-subtitle">K-Means Clustering & Principal Component Analysis</p>
            
            <div class="clustering-images">
                <div class="cluster-image-card">
                    <img src="cluster_elbow_final.png" alt="Cluster Identification - Elbow Method" onerror="this.onerror=null; this.src='cluster_identification_full.png';">
                    <div class="cluster-image-title">Optimal Cluster Identification</div>
                </div>
                
                <div class="cluster-image-card">
                    <img src="cluster_distribution_full.png" alt="Cluster Distribution - PCA">
                    <div class="cluster-image-title">Cluster Distribution (PCA)</div>
                </div>
            </div>
        </div>
...
def main():
    ...
    print(f"\nMake sure your files are in 'outputs/' folder:")
    print(f"  Maps:")
    ...
    print(f"  Clustering Images:")
    print(f"    - cluster_elbow_final.png (or cluster_identification_full.png)")
    print(f"    - cluster_distribution_full.png")
